...
def pdf_to_docx(choice, docs):
        ...
        if int(choice) == 0:
            ...
            for i in list(docs.values()):
                ...
                pdf_conv.close()
                print(f'Файл {i} успешно конвертирован из .pdf в .docx !')
            ...
            if type(docs) is dict:
                ...
                pdf_conv.convert(docx_file)
                pdf_conv.close()
                print(f'Файл {pdf_file} успешно конвертирован из .pdf в .docx !')
...
def docx_to_pdf(choice, docs):
        ...
        if int(choice) == 0:
            ...
            for i in list(docs.values()):
                ...
                pdf_file = i[:-4] + 'pdf'
                convert(i, pdf_file)
                print(f'Файл {i} успешно конвертирован из .docx в .pdf !')
            ...
            if type(docs) is dict:
                ...
                print(f'Файл {docx_file} успешно конвертирован из .docx в .pdf !')
